...
(2, '2013-06-27 14:02:12', '::1', 0x646f5f6c6f67696e2e706870202d3e206c6f67696e20737563636573732e);
...
--
-- 转存表中的数据 `mission_review`
--

INSERT INTO `mission_review` (`id`, `review_word`) VALUES
(1, 0x6170706c65),
(2, 0x617070656172),
(3, 0x6170706c79),
(4, 0x61646d697265),
...
(7, 'LAST_MISSION_ID', 0x32, 0x30),
(8, 'MISSION_REVIEW_1', 0x322c3536, ''),
(9, 'MISSION_REVIEW_2', 0x32, ''),
(10, 'MISSION_REVIEW_3', '', ''),
(11, 'MISSION_REVIEW_4', 0x31, '');
...
(3, 'apple', '', '2013-06-27 12:09:38', '2013-06-27 04:09:38', 1, 'word', 3, 2, 1, NULL, '', '', 'public', ''),
(4, '第2课', '', '2013-06-27 14:40:19', '2013-06-27 06:40:19', 1, 'class', 4, 0, 1, NULL, '', '', 'public', ''),
(5, 'appear', '', '2013-06-27 14:40:33', '2013-06-27 06:40:33', 1, 'word', 5, 2, 1, NULL, '', '', 'public', ''),
(6, '第3课', '', '2013-06-27 14:42:05', '2013-06-27 06:42:05', 1, 'class', 6, 0, 1, NULL, '', '', 'public', ''),
(7, '第2单元', '', '2013-06-27 14:42:06', '2013-06-27 06:42:06', 1, 'unit', 7, 1, 1, NULL, '', '', 'public', ''),
(8, 'apply', '', '2013-06-27 14:42:14', '2013-06-27 06:42:14', 1, 'word', 8, 2, 1, NULL, '', '', 'public', ''),
(9, 'admire', '', '2013-06-27 14:42:43', '2013-06-27 06:42:43', 1, 'word', 9, 2, 1, NULL, '', '', 'public', ''),
(10, 'use', '', '2013-06-27 14:46:18', '2013-06-27 06:46:18', 1, 'word', 10, 2, 1, NULL, '', '', 'public', '');
...
(1, 'admin', 'dd94709528bb1c83d08f3088d4043f4742891f4f', 'admin@admin.com', '管理员', 1, '2013-03-20 11:15:57', '2013-06-27 22:02:12', 0, '7nlk26kjv3fmqv9jgseo7nn292', 1, 0);
...
CREATE TABLE IF NOT EXISTS `word_info` (
  ...
  `info_pho` varchar(100) COLLATE utf8_bin DEFAULT NULL COMMENT '音标',
  `info_img` varchar(300) COLLATE utf8_bin DEFAULT NULL COMMENT '图片文件地址',
  `info_voice` varchar(300) COLLATE utf8_bin DEFAULT NULL COMMENT '音频文件地址',
  `info_des` text COLLATE utf8_bin COMMENT '解释',
  `info_note` varchar(300) COLLATE utf8_bin DEFAULT NULL COMMENT '注记',
  `info_dict` text COLLATE utf8_bin COMMENT '例句',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=14330 ;